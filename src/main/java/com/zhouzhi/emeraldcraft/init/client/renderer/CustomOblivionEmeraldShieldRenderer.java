...
@OnlyIn(Dist.CLIENT)
public class CustomOblivionEmeraldShieldRenderer extends BlockEntityWithoutLevelRenderer {
    private static final Minecraft mc = Minecraft.getInstance();
    private final ShieldModel shieldModel;
    private static final ResourceLocation SHIELD_TEXTURE =
            ResourceLocation.fromNamespaceAndPath("emeraldcraft", "textures/entity/oblivion_emerald_shield.png");

    public CustomOblivionEmeraldShieldRenderer() {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext context, PoseStack poseStack,
        ...
        if (player != null) {
            blocking = Use.Render.isBlocking(player, stack,ModItems.OBLIVION_EMERALD_SHIELD);
        }
