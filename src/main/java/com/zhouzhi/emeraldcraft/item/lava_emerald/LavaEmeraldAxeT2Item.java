...
public class LavaEmeraldAxeT2Item extends AxeItem {
	private static final int BAR_COLOR = FastColor.ARGB32.color(0, 255, 151, 71);
	...
	public LavaEmeraldAxeT2Item() {
		super(TIER, new Properties()
				.attributes(DiggerItem.createAttributes(TIER, 15f, -3f))
