...
public class LavaEmeraldShovelT2Item extends ShovelItem {
	private static final int BAR_COLOR = FastColor.ARGB32.color(0, 252, 149, 59);
	...
	public LavaEmeraldShovelT2Item() {
